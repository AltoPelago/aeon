...
For example, after the TypeScript `0.12.1` release commit is merged to `main`:

```sh
git checkout main
git pull --ff-only
git tag -s typescript/v0.12.1 -m "AEON TypeScript packages 0.12.1"
git tag -v typescript/v0.12.1
git push origin typescript/v0.12.1
```
...
- CTS line: `v1`
- TypeScript implementation/package line: `0.12.1`
- Python implementation/package line: `0.12.1`
- Rust implementation/package line: `0.12.1`
