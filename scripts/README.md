...
| `check-sofia-parser-differential.py` | Regenerates and hash-verifies the frozen Sofia corpus, then compares complete strict and recovery parser results between the internal Baseline and Sofia selectors. | `npm run test:sofia:differential` |
