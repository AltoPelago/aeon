...
const cases = [
  ...
  { name: 'wtc-custom-type', binding: 'meeting:myZrut = 2025-12-02T02:00:00Z&Asia/Tokyo', compileOptions: { datatypePolicy: 'allow_custom' }, expectPass: true, path: 'meeting', datatype: 'myZrut' },
