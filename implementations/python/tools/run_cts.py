...
def main() -> int:
    ...
    if requested:
        ...
        if unknown:
            ...
            print("Valid lanes: core core-released aes aes-released canonical finalize finalize-limits inspect finalize-map sansa sansa-resolve annotations aeos", file=sys.stderr)
            return 2
